  ...
  <div class="autumn-view">
    <header class="hero-section">
      <div class="hero-content">
        ...
        <p class="subtitle">
          秋日的吉林大学，褪去了夏日的浮躁，披上了五彩的锦衣，每一片落叶都诉说着成熟与收获的故事。
        </p>
      </div>
    </header>
    ...
    <main class="content-section">
      <article class="autumn-description">
        ...
        <img
          src="../../assets/imgs/sceneryView/autumn1.jpg"
          alt="吉大秋日风光一"
        ...
        <img
          src="../../assets/imgs/sceneryView/autumn2.jpg"
          alt="吉大秋日风光二"
          class="inline-season-image"
        />
        <p>
        ...
        <img
          src="../../assets/imgs/sceneryView/autumn3.jpg"
          alt="吉大秋日风光三"
          class="inline-season-image"
        />
        <p>
